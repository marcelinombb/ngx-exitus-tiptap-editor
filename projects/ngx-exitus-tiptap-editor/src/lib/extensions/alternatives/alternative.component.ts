...
@Component({
    ...
    template: `
    <div class="ex-alternative-wrapper" 
      ...
      <div class="ex-alternative-controls" contenteditable="false" *ngIf="editor().isEditable">
        ...
        <div class="controls-right">
          <editor-button icon="delete-bin" title="Remover Alternativas" (onClick)="removeAlternative()"></editor-button>
        </div>
      </div>

      <div class="ex-alternative-col-wrapper">
          <div class="ex-alternative-content" data-node-view-content></div>
          <div contenteditable="false" class="ex-alternative-add-btn-wrapper" *ngIf="editor().isEditable">
              <button class="ex-alternative-add-btn" (click)="addAlternativeItem($event)" title="Adicionar item">
                 + Item
              </button>
          </div>
      </div>
