...
export const AssociationColumn = Node.create<AssociationColumnOptions>({
    ...
    renderHTML({ HTMLAttributes }) {
        return [
            'div', mergeAttributes(HTMLAttributes, { 'data-type': 'association-column', class: 'ex-association-col-wrapper' }),
    ...
    addNodeView() {
        ...
        return AngularNodeViewRenderer(AssociationColumnComponent, { injector: this.options.injector! });
    },
});
